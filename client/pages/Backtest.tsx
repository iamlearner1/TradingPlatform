  ...
  return (
    <div className="h-screen bg-gray-50 flex flex-col overflow-hidden">
      <div className="bg-white border-b border-gray-100 flex items-center px-4 py-3 flex-shrink-0 relative z-10 shadow-sm">
        ...
        <h1 className="text-base font-bold text-gray-900 ml-2">Backtest</h1>
      </div>
      <div className="flex-1 overflow-y-auto p-4">
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 text-center flex flex-col items-center justify-center min-h-[60vh]">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">Strategy Backtesting</h2>
          <p className="text-gray-500 text-sm leading-relaxed max-w-xs mx-auto">
            Test your trading strategies using historical market data spanning multiple years to evaluate performance.
          </p>
        </div>
      </div>
    </div>
