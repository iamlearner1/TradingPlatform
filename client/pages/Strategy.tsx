  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setIndices(prev => prev.map(index => {
        const volatility = index.price * 0.0003; 
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] flex flex-col pb-20">
      <div className="bg-[#312579] border-b flex items-center px-4 py-3 flex-shrink-0 relative z-10 shadow-sm text-white">
        ...
        <div className="ml-2">
           <h1 className="text-base font-bold text-white leading-tight">Strategy Builder</h1>
           <p className="text-[10px] text-white/70 font-medium">Select an index to build strategy & view payoff</p>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="flex items-center justify-between mb-4 mt-1 px-1">
          <h2 className="text-sm font-bold text-gray-900 uppercase tracking-wide flex items-center gap-2">
            <Target className="w-4 h-4 text-violet-600" /> Options Market
          </h2>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col gap-1.5 pl-1.5">
                  ...
                  <span className="text-[9px] uppercase font-bold tracking-widest text-[#1a5f9e]">Strategy Builder</span>
                </div>
